...
class CatPetRepository {
    val service = CatPetApiClient.makeRetrofitService()
    ...
    fun getTypeCat(resBody: MutableLiveData<Animal>, param: String) {
        CoroutineScope(Dispatchers.IO).launch {
            val response = service.getTypeCat(param)
