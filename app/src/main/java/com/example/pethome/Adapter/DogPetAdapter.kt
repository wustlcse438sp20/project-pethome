...
class DogPetViewHolder(inflater: LayoutInflater, parent: ViewGroup):
...
class DogPetAdapter (private val list: ArrayList<Animals>, context: Context)
    :RecyclerView.Adapter<DogPetViewHolder>() {

    val myContext = context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogPetViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        return DogPetViewHolder(inflater, parent)
    }

    override fun onBindViewHolder(holder: DogPetViewHolder, position: Int) {
